f1=open('merge_GATK_10sample_count_merge.txt','r')
f2=open('merge_GATK_10sample_count_merge_proportion.txt','w')
...
####
f1=open('merge_GATK_10sample_count.txt','r')
f2=open('merge_GATK_10sample_count_proportion.txt','w')
f2.write("Individual\tbase_change\tnumber\tproportion\n")
