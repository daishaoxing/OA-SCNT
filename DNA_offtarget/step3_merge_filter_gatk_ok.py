f1=open('merge_15sample_add_gatk_v1.txt','r')
f2=open('merge_15sample_filter_gatk_v1.txt','r')
f3=open('merge_15sample_filter_add_gatk_v1.txt','w')
f4=open('merge_15sample_filter_add_count_gatk_v1.txt','w')
f5=open('merge_15sample_filter_add_change_gatk_v1.txt','w')
...
print ('gatk',len(filter_list1))
print ('gatk',len(filter_list2))
f2.close()
difset1=list(set(filter_list2)-set(filter_list1))
difset2=list(set(filter_list1)-set(filter_list2))
print ('gatk',len(difset1))
print ('gatk',len(difset2))
print('gatk',len(set(filter_list)))
