...
fout=open('merge_26sample_filter_strelka2_v1.txt','w')
...
ref_07027,dict_07027,list_07027=write_get_info('../vcf_2021/07027_strelka2_SNP.txt')
ref_08431GFP,dict_08431GFP,list_08431GFP=write_get_info('../vcf_2021/08431GFP_strelka2_SNP.txt')
ref_08431neg,dict_08431neg,list_08431neg=write_get_info('../vcf_2021/08431neg_strelka2_SNP.txt')
ref_08431pos,dict_08431pos,list_08431pos=write_get_info('../vcf_2021/08431pos_strelka2_SNP.txt')
ref_08431WT,dict_08431WT,list_08431WT=write_get_info('../vcf_2021/08431WT_strelka2_SNP.txt')
ref_090202body,dict_090202body,list_090202body=write_get_info('../vcf_2021/090202body_strelka2_SNP.txt')
ref_090202head,dict_090202head,list_090202head=write_get_info('../vcf_2021/090202head_strelka2_SNP.txt')
ref_NC1,dict_NC1,list_NC1=write_get_info('../vcf_2021/NC1_strelka2_SNP.txt')
ref_NC2,dict_NC2,list_NC2=write_get_info('../vcf_2021/NC2_strelka2_SNP.txt')
ref_NC3,dict_NC3,list_NC3=write_get_info('../vcf_2021/NC3_strelka2_SNP.txt')
ref_NC4,dict_NC4,list_NC4=write_get_info('../vcf_2021/NC4_strelka2_SNP.txt')
ref_NC5,dict_NC5,list_NC5=write_get_info('../vcf_2021/NC5_strelka2_SNP.txt')
ref_NC6,dict_NC6,list_NC6=write_get_info('../vcf_2021/NC6_strelka2_SNP.txt')
ref_NC7,dict_NC7,list_NC7=write_get_info('../vcf_2021/NC7_strelka2_SNP.txt')
ref_NC8,dict_NC8,list_NC8=write_get_info('../vcf_2021/NC8_strelka2_SNP.txt')
ref_NC9,dict_NC9,list_NC9=write_get_info('../vcf_2021/NC9_strelka2_SNP.txt')
ref_cloningJR,dict_cloningJR,list_cloningJR=write_get_info('../vcf_2021/cloning-JR_strelka2_SNP.txt')
ref_cloningPF,dict_cloningPF,list_cloningPF=write_get_info('../vcf_2021/cloning-PF_strelka2_SNP.txt')
ref_cloningW,dict_cloningW,list_cloningW=write_get_info('../vcf_2021/cloning-W_strelka2_SNP.txt')
ref_PC1,dict_PC1,list_PC1=write_get_info('../vcf_2021/PC1_strelka2_SNP.txt')
ref_PC2,dict_PC2,list_PC2=write_get_info('../vcf_2021/PC2_strelka2_SNP.txt')
ref_PC3,dict_PC3,list_PC3=write_get_info('../vcf_2021/PC3_strelka2_SNP.txt')
ref_PC4,dict_PC4,list_PC4=write_get_info('../vcf_2021/PC4_strelka2_SNP.txt')
ref_PC5,dict_PC5,list_PC5=write_get_info('../vcf_2021/PC5_strelka2_SNP.txt')
ref_PC6,dict_PC6,list_PC6=write_get_info('../vcf_2021/PC6_strelka2_SNP.txt')
ref_PC7,dict_PC7,list_PC7=write_get_info('../vcf_2021/PC7_strelka2_SNP.txt')
ref_PC8,dict_PC8,list_PC8=write_get_info('../vcf_2021/PC8_strelka2_SNP.txt')
