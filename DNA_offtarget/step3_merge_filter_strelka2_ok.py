f1=open('merge_15sample_add_strelka2_v1.txt','r')
f2=open('merge_15sample_filter_strelka2_v1.txt','r')
f3=open('merge_15sample_filter_add_strelka2_v1.txt','w')
f4=open('merge_15sample_filter_add_count_strelka2_v1.txt','w')
f5=open('merge_15sample_filter_add_change_strelka2_v1.txt','w')
...
print ('strelka2',len(filter_list1))#891929
print ('strelka2',len(filter_list2))#619485
f2.close()
difset1=list(set(filter_list2)-set(filter_list1))
difset2=list(set(filter_list1)-set(filter_list2))
print ('strelka2',len(difset1))##619067
print ('strelka2',len(difset2))##891879
print('strelka2',len(set(filter_list)))##1511414
