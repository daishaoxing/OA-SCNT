...
f1=open('merge_26sample_refgenome_change_strelka2.txt','r')
f2=open('merge_26sample_adddonor_change_strelka2.txt','r')
f3=open('merge_26sample_refgenome_adddonor_count_strelka2.txt','w')
f4=open('merge_26sample_refgenome_adddonor_change_strelka2.txt','w')
f3.write("Individual\tbase_change\tnumber\n")
f4.write("Individual\tpos\tbase_change\n")
...
####################only for test
f3a=open('merge_26sample_refgenome_count_strelka2.txt','w')
f3b=open('merge_26sample_adddonor_count_strelka2.txt','w')
f3a.write("Individual\tbase_change\tnumber\n")
f3b.write("base_change\tIndividual\tpos\n")
