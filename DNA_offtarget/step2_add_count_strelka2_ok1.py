...
dp=40
f1=open('07027_strelka2_SNP.txt','r')
list07027=[]
dictref={}
...
f1=open('08431GFP_strelka2_SNP.txt','r')
list08431GFP=[]
GFP_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('08431WT_strelka2_SNP.txt','r')
list08431WT=[]
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
	if float(tmp[6])>=dp:
...
f1=open('NC1_strelka2_SNP.txt','r')
listNC1=[]
NC1_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('NC2_strelka2_SNP.txt','r')
listNC2=[]
NC2_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('NC3_strelka2_SNP.txt','r')
listNC3=[]
NC3_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC1_strelka2_SNP.txt','r')
listPC1=[]
PC1_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC2_strelka2_SNP.txt','r')
listPC2=[]
PC2_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC3_strelka2_SNP.txt','r')
listPC3=[]
PC3_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC4_strelka2_SNP.txt','r')
listPC4=[]
PC4_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC5_strelka2_SNP.txt','r')
listPC5=[]
PC5_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC6_strelka2_SNP.txt','r')
listPC6=[]
PC6_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC7_strelka2_SNP.txt','r')
listPC7=[]
PC7_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('PC8_strelka2_SNP.txt','r')
listPC8=[]
PC8_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('cloning-W_strelka2_SNP.txt','r')
listcloningW=[]
cloningW_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('cloning-PF_strelka2_SNP.txt','r')
listcloningPF=[]
cloningPF_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('cloning-JR_strelka2_SNP.txt','r')
listcloningJR=[]
cloningJR_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
print ('strelka2',population[8])##0
print ('strelka2',listcloningJR[8])##0
print ('strelka2',len(overlap1))##0
print ('strelka2',len(overlap2))###2946794
difset1=set(overlap2)-set(overlap1)
difset2=list(set(difset1)-set(population))

print ('strelka2',len(difset1))##2946794
print ('strelka2',len(difset2))##2946794

fout=open('merge_15sample_add_strelka2_v1.txt','w')
