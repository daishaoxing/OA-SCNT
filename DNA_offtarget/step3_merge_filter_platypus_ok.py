...
f1=open('merge_26sample_refgenome_change_platypus.txt','r')
f2=open('merge_26sample_adddonor_change_platypus.txt','r')
f3=open('merge_26sample_refgenome_adddonor_count_platypus.txt','w')
f4=open('merge_26sample_refgenome_adddonor_change_platypus.txt','w')
...
####################only for test
f3a=open('merge_26sample_refgenome_count_platypus.txt','w')
f3b=open('merge_26sample_adddonor_count_platypus.txt','w')
