fin=open('merge_26sample_filter_lofreq2_v1.txt','r')
fout1=open('merge_26sample_refgenome_change_lofreq2.txt','w')
fout2=open('merge_26sample_adddonor_change_lofreq2.txt','w')
