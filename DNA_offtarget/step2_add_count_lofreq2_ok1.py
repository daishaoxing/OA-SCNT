...
dp=40
f1=open('07027_lofreq2_SNP.txt','r')
list07027=[]
dictref={}
...
f1=open('08431GFP_lofreq2_SNP.txt','r')
list08431GFP=[]
GFP_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('08431WT_lofreq2_SNP.txt','r')
list08431WT=[]
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
	if float(tmp[6])>=dp:
...
f1=open('cloning-W_lofreq2_SNP.txt','r')
listcloningW=[]
cloningW_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('cloning-PF_lofreq2_SNP.txt','r')
listcloningPF=[]
cloningPF_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
f1=open('cloning-JR_lofreq2_SNP.txt','r')
listcloningJR=[]
cloningJR_dict={}
for i in f1.readlines()[1:]:
	tmp=i.strip().split('\t')
...
print ('lofreq2',population[8])##0
print ('lofreq2',listcloningJR[8])##0
print ('lofreq2',len(overlap1))##0
print ('lofreq2',len(overlap2))###3321027
difset1=set(overlap2)-set(overlap1)
difset2=list(set(difset1)-set(population))

print ('lofreq2',len(difset1))##3321027
print ('lofreq2',len(difset2))##3321027

fout=open('merge_15sample_add_lofreq2_v1.txt','w')
