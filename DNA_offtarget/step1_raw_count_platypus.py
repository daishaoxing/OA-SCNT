...
fout=open('merge_26sample_change_raw_platypus.txt','w')
...
dict1_08431GFP,dict2_08431GFP=write_get_info('../vcf_2021/08431GFP_platypus_SNP.txt')
dict1_08431neg,dict2_08431neg=write_get_info('../vcf_2021/08431neg_platypus_SNP.txt')
dict1_08431pos,dict2_08431pos=write_get_info('../vcf_2021/08431pos_platypus_SNP.txt')
dict1_08431WT,dict2_08431WT=write_get_info('../vcf_2021/08431WT_platypus_SNP.txt')
dict1_090202body,dict2_090202body=write_get_info('../vcf_2021/090202body_platypus_SNP.txt')
dict1_090202head,dict2_090202head=write_get_info('../vcf_2021/090202head_platypus_SNP.txt')
dict1_NC1,dict2_NC1=write_get_info('../vcf_2021/NC1_platypus_SNP.txt')
dict1_NC2,dict2_NC2=write_get_info('../vcf_2021/NC2_platypus_SNP.txt')
dict1_NC3,dict2_NC3=write_get_info('../vcf_2021/NC3_platypus_SNP.txt')
dict1_NC4,dict2_NC4=write_get_info('../vcf_2021/NC4_platypus_SNP.txt')
dict1_NC5,dict2_NC5=write_get_info('../vcf_2021/NC5_platypus_SNP.txt')
dict1_NC6,dict2_NC6=write_get_info('../vcf_2021/NC6_platypus_SNP.txt')
dict1_NC7,dict2_NC7=write_get_info('../vcf_2021/NC7_platypus_SNP.txt')
dict1_NC8,dict2_NC8=write_get_info('../vcf_2021/NC8_platypus_SNP.txt')
dict1_NC9,dict2_NC9=write_get_info('../vcf_2021/NC9_platypus_SNP.txt')
dict1_cloningJR,dict2_cloningJR=write_get_info('../vcf_2021/cloning-JR_platypus_SNP.txt')
dict1_cloningPF,dict2_cloningPF=write_get_info('../vcf_2021/cloning-PF_platypus_SNP.txt')
dict1_cloningW,dict2_cloningW=write_get_info('../vcf_2021/cloning-W_platypus_SNP.txt')
dict1_PC1,dict2_PC1=write_get_info('../vcf_2021/PC1_platypus_SNP.txt')
dict1_PC2,dict2_PC2=write_get_info('../vcf_2021/PC2_platypus_SNP.txt')
dict1_PC3,dict2_PC3=write_get_info('../vcf_2021/PC3_platypus_SNP.txt')
dict1_PC4,dict2_PC4=write_get_info('../vcf_2021/PC4_platypus_SNP.txt')
dict1_PC5,dict2_PC5=write_get_info('../vcf_2021/PC5_platypus_SNP.txt')
dict1_PC6,dict2_PC6=write_get_info('../vcf_2021/PC6_platypus_SNP.txt')
dict1_PC7,dict2_PC7=write_get_info('../vcf_2021/PC7_platypus_SNP.txt')
dict1_PC8,dict2_PC8=write_get_info('../vcf_2021/PC8_platypus_SNP.txt')
