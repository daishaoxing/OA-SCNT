...
def complementv2(strA):
	dna_seq = Seq(strA)
	return str(dna_seq.complement())

f1=open('merge_26sample_filter_add_4method_overlapwithsamplenamewithNC.txt','r')
f2=open('all_edit_site_seqlog_AGv2.txt','w')
...
f1=open('merge_26sample_filter_add_4method_overlapwithsamplenamewithNC.txt','r')
f2=open('all_edit_site_seqlog_CTv2.txt','w')
for i in f1.readlines():
	tmp=i.strip().split('\t')
