...
print ('platypus',population[8])##0
print ('platypus',listcloningJR[8])##0
print ('platypus',len(overlap1))##0
print ('platypus',len(overlap2))###764661
difset1=set(overlap2)-set(overlap1)
difset2=list(set(difset1)-set(population))

print ('platypus',len(difset1))##764661
print ('platypus',len(difset2))##764661

fout=open('merge_15sample_add_platypus_v1.txt','w')
