fin=open('merge_26sample_filter_platypus_v1.txt','r')
fout1=open('merge_26sample_refgenome_change_platypus.txt','w')
fout2=open('merge_26sample_adddonor_change_platypus.txt','w')
